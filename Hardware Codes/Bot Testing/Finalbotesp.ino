     ...
     Serial.printf("Left Stick y at %d\n", PS4.LStickY());
      if (PS4.LStickY()>=-5 && PS4.LStickY()<=5 ) {
            ...
            if (PS4.RStickX()>=-5 && PS4.RStickX()<=5 ) {
              ...
              analogWrite(PWM1,0.3*TPWM);
              digitalWrite(DIR1,LOW);
              analogWrite(PWM2,0.3*TPWM);
              ...
              analogWrite(PWM1,0.3*TPWM);             //Turn Left
        ...
        analogWrite(PWM1,0.3*PWM);
        Serial.println(PS4.LStickY());     
        digitalWrite(DIR1,HIGH);
        analogWrite(PWM2,0.3*PWM);
        digitalWrite(DIR2,HIGH);
        ...
        analogWrite(PWM1,0.3*PWM);            //Backward
        Serial.println(PS4.LStickY());
        digitalWrite(DIR1,LOW);
        analogWrite(PWM2,0.3*PWM);
        digitalWrite(DIR2,LOW);
